VoiceCall readme file
=====================

Copyright © 2018 DSP GROUP, INC
@file		VoiceCall\readme.txt
@version 	V1.0.0

This is a Single threaded application example of MCU software of Voice Call CMND device with UART Rx interrupt without Operation System.
...
This directory contains a set of source files that implements a simple Voice Call application. This application provides following MCU functional:
 - Send Start Voice Call message
 - Send End Voice Call message
 - Send Answer incoming Voice Call message

User can press the button on stm32 device to do this action (depending on call state): 
 - send Start Voice Call message
 - send End Voice Call message
 - send Answer incoming Voice Call message
...
Directory contents
------------------
  - VoiceCall/Inc/main.h 							Header for main.c
  - VoiceCall/Inc/main_extern.h 					Header for main.c
  - VoiceCall/Src/AppExample.c 						Logic to work with button
  - VoiceCall/Src/main.c 							Main program file, initialize GPIO and SysClock, then runs function from AppExample
...
In order to make the program work, you must do the following :
  ...
  - Press button to send start/stop/answer voice call message