...
Description
-----------
This directory contains a set of source files that implements a simple Alert application. This application provides following MCU functional:
 - send Alert message
...
Directory contents
------------------
  - Alert/Inc/main.h 							    Header for main.c
  - Alert/Inc/main_extern.h 					    Header for main.c
  - Alert/Src/AppExample.c 						    Logic to work with button
  - Alert/Src/main.c 							    Main program file, initialize GPIO and SysClock, then runs function from AppExample
...
In order to make the program work, you must do the following:
  ...
  - Press button to send Alert message
