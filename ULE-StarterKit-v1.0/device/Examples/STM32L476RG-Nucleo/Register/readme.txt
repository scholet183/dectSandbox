Register readme file
====================

Copyright © 2018 DSP GROUP, INC
@file		Register/readme.txt
@version 	V1.0.0

This is a Single threaded application example of MCU software to register a device with UART Rx interrupt without Operation System.

Description
-----------
This directory contains a set of source files that implements a simple register application. This application provides following MCU functional:
...
Directory contents
------------------
  - Register/Inc/main.h 				            Header for main.c
  - Register/Inc/main_extern.h 	                    Header for main.c
  - Register/Src/AppExample.c 	                    Logic to work with button
  - Register/Src/main.c 			                Main program file, initialize GPIO and SysClock, then runs function from AppExample
...
In order to make the program work, you must do the following:
  ...
  - Press button to send Register message
